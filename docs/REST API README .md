...
![Passing Tests Example](https://github.com/tm1-oss/vscode-restclient/raw/HEAD/images/tests-passing.png)

An example when some tests have failed.

![Failing Tests Example](https://github.com/tm1-oss/vscode-restclient/raw/HEAD/images/tests-failing.png)

An example when a `JavaScript` error exists in the code.

![Excepted Tests Example](https://github.com/tm1-oss/vscode-restclient/raw/HEAD/images/tests-excepted.png)
...
- `pfx`: Path of PKCS [#12](https://github.com/tm1-oss/vscode-restclient/issues/12) or PFX certificate
...
## License
[MIT License](https://github.com/tm1-oss/vscode-restclient/blob/HEAD/LICENSE)

## Change Log
See CHANGELOG [here](https://github.com/tm1-oss/vscode-restclient/blob/HEAD/CHANGELOG.md)
