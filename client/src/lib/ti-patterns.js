        ...
        generate: ({ dim, srcAttr, aliasAttr, handleBlank }) => {
          ...
          return {
            PrologProcedure: lines(
              ...
              ``,
              `#============`,
              `# Create alias attribute if it doesn't exist`,
              ...
              ``,
              `#============`,
              `# Copy attribute → alias for every element`,
              `#============`,
              ...
              `# to the ${cAlias} attribute and check for repeated values.`,
            ),
          }
        },
      },
