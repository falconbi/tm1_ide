  ...
  },
  {
    ...
    fns: [
      ...
      },
      {
        ...
        signature: 'TM1DRILLDOWNMEMBER(set, memberSet)',
        params: ['set — base set', 'memberSet — members to drill down'],
        description: 'Expand (drill down) specific members within a set.',
